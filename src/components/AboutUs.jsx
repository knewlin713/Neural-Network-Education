...
const AboutUs = forwardRef(({props}, ref) => {
    return(
        ...
        <Flex direction={'column'} gap={'10px'} align={'center'} justify={'center'} marginTop={'75px'}>
            ...
            <Profile profilePicture='src/assets/keyan.jpeg'  about = 'I am awesome and my name is Keyan Rahimi. I am a Computer Science and Cognitve Nueroscience Major at Brown.'/>
